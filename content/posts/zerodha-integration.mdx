...
# Connect Zerodha Kite to Wicklog — Auto-Import Your Trades & Journal Smarter

Stop entering trades manually. Wicklog's Zerodha Kite integration auto-imports your entire trade history so you can focus on journaling and improving.

**By Sachin Sharma · June 11, 2026 · 8 min read**
...
### Step 4 — Sync Your Trades

Navigate to the **Trades** page from the top navigation. You'll see a new **Sync from Zerodha Kite** button at the top right.

![Wicklog Trades page showing the Sync from Zerodha Kite button](/blog/images/sync-trades-from-kite.png)

Click it to open the **Sync Options** modal. Here you can:
...
Once your date range is set, click **Sync Trades**. Your trades will appear in the journal within seconds.
...
> **Note:** Kite Connect access tokens expire daily at **6 AM IST**. You'll need to reconnect each morning to sync new trades.
...
Yes. You can import from any date range available in your Kite account history — even trades made weeks or months ago. Because Zerodha's API only provides today's live data, older trades accumulate over time as you sync each day.

**Will trades sync automatically going forward?**
Trades are not synced in real-time. You click **Sync from Zerodha Kite** on the Trades page whenever you want to import. This keeps you in control and prevents cluttered entries from partial-day trades.
...
Yes. Wicklog also supports **Dhan** via API connection, and you can add trades from any other broker manually. More integrations are coming.
...
4. Return to **Trades** → click **Sync from Zerodha Kite**
5. Choose your date range and click **Sync Trades**
